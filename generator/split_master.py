...
if __name__ == "__main__":
  try:
    images_dir = "./Prostate-Train-Tumor-augmented-master/images/"
    masks_dir  = "./Prostate-Train-Tumor-augmented-master/masks/"
    output_dir = "./Pre-Augmented-RINGS-Prostate-Tumor-ImageMask-Dataset/"
