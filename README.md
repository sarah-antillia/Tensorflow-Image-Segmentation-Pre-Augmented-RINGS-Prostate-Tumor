<h2>Tensorflow-Image-Segmentation-Pre-Augmented-RINGS-Prostate-Tumor (2025/01/03)</h2>

This is the third experiment of Image Segmentation for RINGS Prostate Tumor 
 based on 
the latest <a href="https://github.com/sarah-antillia/Tensorflow-Image-Segmentation-API">Tensorflow-Image-Segmentation-API</a>, 
and a pre-augmented <a href="https://drive.google.com/file/d/1F22CzN22vBp9EfmFza7vXuzx5wcyqmIh/view?usp=sharing">
Pre-Augmented-RINGS-Prostate-Tumor-ImageMask-Dataset.zip</a>, which was derived by us from 
...
<br>
Please see also the first and second experiments for RINGS-Prostate-Tumor <br>
<li> <a href="https://github.com/sarah-antillia/Tensorflow-Image-Segmentation-RINGS-Prostate-Tumor">Tensorflow-Image-Segmentation-RINGS-Prostate-Tumor</a> </li>
<li> <a href="https://github.com/sarah-antillia/Tensorflow-Tiled-Image-Segmentation-RINGS-Prostate-Tumor">Tensorflow-Tiled-Image-Segmentation-RINGS-Prostate-Tumor</a> </li>


<br>
<b>Data Augmentation Strategy:</b><br>
 To address the limited size of RINGS-Prostate-Tumor, which contains 1000 images and their corresponding masks in the Train dataset, 
 we employed <a href="./generator/Pre-Augmented-TrainTumorImageMaskDatasetGenerator.py">an offline augmentation tool</a> to generate a pre-augmented dataset, which supports the following augmentation methods.
<br><br>
<li>Vertical flip</li>
...
<a href="https://drive.google.com/file/d/1F22CzN22vBp9EfmFza7vXuzx5wcyqmIh/view?usp=sharing">
Pre-Augmented-RINGS-Prostate-Tumor-ImageMask-Dataset.zip</a>
...
This is a pre-augmented 512x512 pixels JPG dataset generated from 1500x1500 pixels IMAGES and MANUAL_TUMOR of TRAIN only.<br>
...
On the derivation of our dataset, please refer to  the following Python scripts.<br>
<li><a href="./generator/Pre-Augmented-TrainTumorImageMaskDatasetGenerator.py">Pre-Augmented-TrainTumorImageMaskDatasetGenerator.py</a></li>
...
<img src="./projects/TensorflowSlightlyFlexibleUNet/Prostate-Tumor/asset/epoch_change_infer_starting.png" width="1024" height="auto"><br>
<br>
<br>
<b>Epoch_change_inference output at ending (68,69,70)</b><br>
<img src="./projects/TensorflowSlightlyFlexibleUNet/Prostate-Tumor/asset/epoch_change_infer_ending.png" width="1024" height="auto"><br>
<br>
<br>
<br>
In this experiment, the training process was stopped at epoch 70  by EarlyStopping Callback.<br><br>
<img src="./projects/TensorflowSlightlyFlexibleUNet/Prostate-Tumor/asset/train_console_output_at_epoch_70.png" width="720" height="auto"><br>
<br>
...
<img src="./projects/TensorflowSlightlyFlexibleUNet/Prostate-Tumor/asset/evaluate_console_output_at_epoch_70.png" width="720" height="auto">
...
The loss (bce_dice_loss) to this Prostate-Tumor/test was low, and dice_coef high as shown below.
<br>
<pre>
loss,0.1724
dice_coef,0.902
